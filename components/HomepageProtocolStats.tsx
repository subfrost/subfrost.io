...
const copy = {
  en: {
    fallback: "—",
    items: [
      { key: "totalBtcLocked", label: "Total BTC locked", suffix: "BTC", href: "/volume" },
      { key: "currentFrbtcSupply", label: "Current frBTC supply", suffix: "frBTC", href: "/volume" },
      { key: "lifetimeTxValueBtc", label: "Lifetime tx value", suffix: "BTC", href: "/volume" },
  ...
  zh: {
    fallback: "—",
    items: [
      { key: "totalBtcLocked", label: "锁定 BTC 总量", suffix: "BTC", href: "/volume?lang=zh" },
      { key: "currentFrbtcSupply", label: "当前 frBTC 供应", suffix: "frBTC", href: "/volume?lang=zh" },
      { key: "lifetimeTxValueBtc", label: "累计交易价值", suffix: "BTC", href: "/volume?lang=zh" },
