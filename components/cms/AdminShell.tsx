    ...
    >
      ...
      {open && (
        <div className="fixed inset-0 z-40 lg:hidden">
          ...
          <aside className="ed-admin-scroll ed-admin-reveal absolute left-0 top-0 flex h-full w-[296px] flex-col overflow-y-auto border-r border-[color:var(--ed-hair)] bg-[color:var(--ed-canvas)] p-5 shadow-[20px_0_70px_rgba(0,0,0,0.18)]">
