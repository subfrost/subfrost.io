          ...
          <div>
            ...
            {canEdit ? (
              <div className="mt-1 space-y-2">
                <label className="inline-flex items-center gap-2 text-sm text-[color:var(--ed-body)]">
                  <input
                    type="checkbox"
                    aria-label="Blocked"
                    checked={task.blocked}
                    onChange={(e) => run(() => updateTaskAction(task.id, { blocked: e.target.checked }))}
                    className="h-3.5 w-3.5 rounded border-[color:var(--ed-hair)] bg-[color:var(--ed-surface)] text-rose-500 focus:ring-0"
                  />
                ...
                {task.blocked && (
                  <input
                    ...
                    className="w-full rounded-[6px] border border-rose-500/30 bg-rose-500/5 px-2 py-1.5 text-sm text-rose-300 placeholder:text-rose-400/50 focus:outline-none"
                  />
                )}
              </div>
            ) : task.blocked ? (
              ...
              <p className="mt-1 text-sm text-[color:var(--ed-muted)]">Not blocked</p>
            )}
          </div>
