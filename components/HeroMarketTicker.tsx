...
export default function HeroMarketTicker({
  ...
  const items = [
    { label: copy.btcHeight, value: formatInteger(stats?.btcHeight, copy.fallback), icon: Bitcoin, href: "https://app.subfrost.io/" },
    { label: copy.msHeight, value: formatInteger(stats?.metashrewHeight, copy.fallback), icon: RadioTower, href: "https://app.subfrost.io/" },
    { label: "BTC/USD", value: formatUsd(stats?.btcPrice, copy.fallback), icon: Activity, href: "https://app.subfrost.io/" },
