...
function renderBlock(block: DocBlock, index: number) {
  ...
  return (
    <div key={index} className="overflow-hidden rounded-[6px] border" style={{ borderColor: "var(--ed-hair)" }}>
...
export default async function DocPage({ params }: Props) {
  ...
  return (
    <EditorialShell>
      <main>
        <section>
          <div className="mx-auto max-w-[1440px] px-6 pb-14 pt-12 sm:px-8 sm:pb-20 sm:pt-[104px]">
            <div className="max-w-[880px]">
              <p className="font-display text-[15px] font-medium" style={{ color: "var(--ed-muted)" }}>
                {page.section}
              </p>
              <h1 className="font-display mt-5 text-[48px] font-normal leading-[1.02] sm:text-[72px]" style={{ color: "var(--ed-ink)" }}>
                {page.title}
              </h1>
