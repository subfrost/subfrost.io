...
export const docPages: DocPage[] = [
  ...
  {
    slug: "introduction/app-overview",
    section: "Introduction",
    title: "SUBFROST APP overview",
    description: "The in-development app experience for Bitcoin L1 UX.",
    sourceUrl: "https://docs.subfrost.io/introduction/subfrost-app-overview",
    blocks: [
      { type: "p", text: "The SUBFROST APP overview introduces the product surface currently in development and frames the goal: showing the best possible UX on Bitcoin L1." },
      { type: "list", items: ["Bring Bitcoin-native activity into a coherent app surface.", "Keep protocol complexity behind clear product flows.", "Use the app pages for deeper swap, vault, futures, and wallet context."] },
    ],
  },
  {
    slug: "app/overview",
  ...
  },
  {
    ...
    section: "subfrost App",
    title: "FIRE Vault",
    description: "Staking and bonding mechanics for FIRE through the DIESEL/frBTC LP vault.",
    sourceUrl: "https://docs.subfrost.io/subfrost-app/fire-vault",
    blocks: [
      { type: "p", text: "The FIRE Vault is the staking entry point for FIRE, a utility token built on Alkanes that rewards liquidity providers in the DIESEL/frBTC pool." },
      { type: "list", items: ["Stake DIESEL/frBTC LP tokens to earn FIRE.", "Lock positions for higher multipliers, from no lock up to one year.", "FIRE has no premine, with emissions distributed through staking and bonding.", "NFT positions can represent vault stake and may be split into wrapped LP position claims."] },
      { type: "table", rows: [["Maximum supply", "2,100,000 FIRE"], ["Premine", "0%"], ["Staking pool", "85%"], ["Bonding pool", "15%"], ["Halving interval", "105,000 blocks"]] },
      { type: "p", text: "The docs also describe bonding, redemption, reference prices, and the economic flywheel between staking, bonding, and the treasury-backed floor." },
    ],
  },
  {
    slug: "app/futures",
  ...
  {
    slug: "tokens/minting-dxbtc",
    section: "Tokens",
    title: "Minting and burning dxBTC",
    description: "dxBTC mint and burn flows through subfrost-cli.",
    sourceUrl: "https://docs.subfrost.io/tokens/minting-dxBTC",
    blocks: [
      { type: "p", text: "The upstream docs cover dxBTC actions through subfrost-cli: minting locks BTC into the dxBTC flow, while burning exits the position." },
      { type: "p", text: "Use this reference beside the dxBTC overview when moving from product concept to command-line operation." },
    ],
  },
  {
    slug: "tokens/fuel",
  ...
  },
  {
    ...
    sourceUrl: "https://docs.subfrost.io/key-components/frost-and-roast",
    blocks: [
  ...
  },
  {
    ...
    sourceUrl: "https://docs.subfrost.io/subfrost-networking/gossipsub-and-encrypted-communication",
    blocks: [
  ...
  },
  {
    ...
    section: "Reference",
    title: "Glossary",
    description: "Definitions for core subfrost protocol, signing, custody, and networking terms.",
    sourceUrl: "https://docs.subfrost.io/reference/glossary",
    blocks: [
      { type: "table", rows: [["FROST", "Flexible Round-Optimized Schnorr Threshold signing."], ["ROAST", "A robustness layer for threshold signing when some participants are offline or adversarial."], ["frBTC", "The Bitcoin DeFi-compatible BTC asset pegged 1:1 to native BTC."], ["dxBTC", "Yield-bearing BTC built on top of frBTC strategy deployment."], ["subp2p", "The peer-to-peer networking base for subfrost services."]] },
    ],
  },
  {
    slug: "reference/subfrost-cli",
    section: "Reference",
    title: "subfrost-cli",
    description: "Command-line interface for interacting with the SUBFROST network.",
    sourceUrl: "https://docs.subfrost.io/reference/subfrost-cli-reference",
    blocks: [
      { type: "p", text: "The subfrost-cli reference covers commands, subcommands, and flags for interacting with the SUBFROST network." },
      { type: "list", items: ["Manage FROST keystores and signing ceremonies.", "Interact with JSON-RPC services running on the network.", "Run node and peer-to-peer networking flows.", "Wrap and unwrap frBTC, mint and burn dxBTC, stake, and participate in governance."] },
    ],
  },
  {
  ...
  {
    slug: "reference/subrail-cli",
    section: "Reference",
    title: "subrail-cli",
    description: "Command-line interface for interacting with Subrail runtime and Alkanes AMM functionality.",
    sourceUrl: "https://docs.subfrost.io/reference/subrail-cli-reference",
    blocks: [
      { type: "p", text: "The subrail-cli reference covers commands, subcommands, and flags for interacting with the Subrail runtime." },
      { type: "list", items: ["Interact with the Subrail runtime.", "Use AMM functionality in the Alkanes metaprotocol.", "Pair this reference with the Alkanes integration docs when building operational workflows."] },
    ],
  },
]
