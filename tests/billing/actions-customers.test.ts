...
describe('reads', () => {
  it('listCustomersAction passes through live flag', async () => {
  ...
  it('getCustomerAction returns customer detail', async () => {
    asUser(['MANAGE_BILLING']);
  ...
  it('listRefundIntentsAction calls listIntents with REFUND', async () => {
    asUser(['MANAGE_BILLING']);
...
describe('mutations', () => {
  it('requestRefundAction audits stripe_refund_request + revalidates', async () => {
    asUser(['MANAGE_BILLING']);
