...
export const __wbg_wasmgrpcchannel_free: (a: number, b: number) => void;
export const __wbg_wasmpumpedduplex_free: (a: number, b: number) => void;
export const connectGrpcChannel: (a: number, b: number, c: number) => any;
export const wasmgrpcchannel_callUnary: (a: number, b: number, c: number, d: number, e: number) => any;
