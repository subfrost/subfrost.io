...
impl ConfigBuilder<ClientConfig, WantsClientCert> {
    ...
    pub fn with_client_cert_resolver(
        ...
        ClientConfig {
            ...
            // tlsfetch fork: opt-in mutator defaults off so behavior
            // matches upstream rustls 0.23.38 byte-for-byte unless
            // the caller installs a mutator explicitly.
            client_hello_mutator: None,
        }
    }
}
