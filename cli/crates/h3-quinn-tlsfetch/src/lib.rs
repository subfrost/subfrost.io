...
// tlsfetch fork: datagram module dropped along with the
// h3-datagram optional dep. Not used by tlsd. Restore by
// vendoring h3-datagram + re-adding the module if needed.
